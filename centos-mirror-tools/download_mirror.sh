...
usage() {
    ...
    echo
    echo "Common Options:"
    echo "  -c <dnf.conf>: Use an alternate dnf.conf rather than the system file"
    echo "                 Suggested valur is 'dnf.conf.sample' in this directory."
...
echo "    - ${DL_MIRROR_OUTPUT_DIR}/Binary/images/install.img"
